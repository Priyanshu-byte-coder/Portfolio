...
export const EXPERIENCES: Experience[] = [
  { role: 'CTO Office Intern', company: 'Valura.ai', duration: 'Aug 2026 — Present', type: 'Remote', desc: '' },
  { role: 'AI/ML Engineer Intern', company: 'Velino AI', duration: 'Jun — Aug 2026', type: 'Remote', desc: 'Built two production AI SaaS products from scratch — Salesnix AI: B2B voice ordering agent (Gemini Live, Pipecat-AI WebRTC, Silero VAD, WhatsApp Cloud API, live tool calls, Razorpay); Sociafy: multi-model content pipeline (GPT-5, Claude agentic loops, Modal GPU TTS/video, OAuth 2.0, Stripe/Razorpay billing).' },
